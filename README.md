...
Using the loop made the coding much easier. I started the code using if-statements, but that caused my code to be overly long and complicated. To make the program countown from 10 to zero, you only need a total of 7 lines. I worked with the person next to me [#https://github.com/egarcia28/Engineering_4_Notebook/tree/main/raspberry-pi](https://github.com/egarcia28/Engineering_4_Notebook/tree/main/raspberry-pi)
